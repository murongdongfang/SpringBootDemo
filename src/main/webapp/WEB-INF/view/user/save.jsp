					...
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
						<div class="widget am-cf">
							...
							<div class="widget-body am-fr">
								...
								<form action="/user/saveOpt" method="post" class="am-form tpl-form-line-form">


									<div class="am-form-group">
										<label for="user-name" class="am-u-sm-3 am-form-label">账号</label>
										<div class="am-u-sm-9">
											<input name="name" type="text" class="tpl-form-input" id="user-name"
												placeholder="请输入账号">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class= "am-u-sm-9">
											<input name="pwd" type="text" class="tpl-form-input" id="user-name"
												placeholder="请输入账号">
										</div>
									</div>
